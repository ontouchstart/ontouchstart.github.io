image=2026_06_23_nvim_rustup_elan
versions:Dockerfile;docker run --rm $(image) make versions&&docker images
...
WORKDIR /home
RUN echo "versions:;rustc --version&&cargo --version&&elan --version&&lake --version" > Makefile
